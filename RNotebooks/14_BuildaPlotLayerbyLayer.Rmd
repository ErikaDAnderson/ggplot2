...
ggplot(mpg) +
  geom_density(aes(displ, after_stat(density)), color = "tomato") +
  stat_function(aes(displ), fun = dnorm, args = c(mean = meandispl, sd = sddipl), col = "blue")
# legend missing still
# must be simpler way to add both - anyone else?
